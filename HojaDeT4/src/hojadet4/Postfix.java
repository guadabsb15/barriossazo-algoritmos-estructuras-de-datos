...
public class Postfix {
    ...
    public static void main(String[] args) {
        ...
        StackList<Double> pila= new StackList();
     ...
     */
     public static void leerNumero(Scanner sc, StackList pila)
    {   
        Scanner s=sc;
        StackList p=pila;
        double numero;
      ...
      * @param pila stack usado para la evaluacion de la expresion
      */
     public static void leerOperacion(Scanner sc, StackList pila)
    {
        Scanner s=sc;
        StackList<Double> p=pila;
        int operacion;
